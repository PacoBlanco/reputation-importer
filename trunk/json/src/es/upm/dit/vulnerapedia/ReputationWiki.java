...
public class ReputationWiki {
	...
	static public void main(String[] args) throws Exception {
		...
		if(System.getProperties().getProperty("os.name").toLowerCase().indexOf("windows") != -1) {
			Ejecutor.ConfigureExtractorMode(Ejecutor.SCRAPPY_EXECUTOR_SERVER,Property.getURL_SERVER());
		} else {
			Ejecutor.ConfigureExtractorMode(Ejecutor.SCRAPPY_EXECUTOR_LINE_COMMAND,Property.getURL_SERVER());
		}
